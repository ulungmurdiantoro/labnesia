...
<nav>
  ...
  <div class="nav-links">
    ...
    <a href="<?php echo $url_inhouse; ?>">In House</a>
    <a href="<?php echo $url_faq; ?>">FAQ</a>
    <a href="#daftar" class="nav-cta">Daftar Pelatihan</a>
  </div>
</nav>
...
<footer>
  <div class="footer-bottom">
    ...
    <span>📞 +62 821-7222-1567 (Endang) · +62 851-8500-0367 (Berryl) · +62 811-399-523 (Kintan)</span>
  </div>
</footer>
