...
<style>
  ...
  :root{--navy:#0B1F3A;--teal:#1A9E75;--teal-light:#22C28F;--teal-pale:#E8F7F2;--amber:#F5A623;--amber-pale:#FEF3DC;--white:#FFFFFF;--gray-50:#F8F9FA;--gray-100:#F1F3F5;--gray-200:#E9ECEF;--gray-300:#DEE2E6;--gray-400:#ADB5BD;--gray-600:#6C757D;--gray-700:#495057;--gray-800:#343A40;--font-display:'Plus Jakarta Sans',sans-serif;--font-serif:'Lora',serif}
...
<nav>
  ...
  <div class="nav-links">
    ...
    <a href="<?php echo $url_kelas; ?>#daftar" class="nav-cta">Daftar Sekarang</a>
  </div>
</nav>
  ...
  <div class="comp-inner">
    ...
    <div class="comp-wrap">
      <table class="comp-full">
        <thead>
          <tr>
            <th style="min-width:200px">Aspek</th>
            <th>Mandiri<br><span style="font-weight:400;font-size:12px">Tanpa program</span></th>
        ...
        <tbody>
          <tr class="row-group-header"><td colspan="6">Biaya &amp; Investasi</td></tr>
          <tr><td>Investasi awal</td><td><span class="price-tag">Rp 0</span><span class="price-sub">Modal waktu &amp; energi</span></td><td><span class="price-tag">Rp 2–7 jt</span><span class="price-sub">Per orang</span></td><td class="col-featured"><span class="price-tag">Rp 14–35 jt</span><span class="price-sub">1–3 peserta/lab</span></td><td><span class="price-tag">Rp 36 jt</span><span class="price-sub">Per lab (privat)</span></td><td><span class="price-tag">Rp 150–200 jt</span><span class="price-sub">Per lab</span></td></tr>
          <tr><td>Nilai benefit gratis</td><td><span class="check-no">—</span></td><td><span class="check-no">—</span></td><td class="col-featured"><strong style="color:var(--teal)">s.d. Rp 20 jt</strong></td><td><span class="check-no">—</span></td><td><span class="check-partial">Termasuk dalam biaya</span></td></tr>
          <tr class="row-group-header"><td colspan="6">Durasi &amp; Struktur</td></tr>
          <tr><td>Durasi program</td><td>Tidak terbatas (umumnya 2–4 tahun)</td><td>1–5 hari</td><td class="col-featured"><strong>6 bulan terstruktur</strong></td><td>2–3 bulan</td><td>6–12 bulan</td></tr>
          <tr><td>Format pelaksanaan</td><td>Mandiri</td><td>Online / Offline</td><td class="col-featured">Online + Hybrid</td><td>Privat online</td><td>In-house onsite</td></tr>
          <tr><td>Jumlah peserta</td><td>—</td><td>Publik (terbuka)</td><td class="col-featured"><strong>Maks. 10 instansi</strong></td><td>1 lab (privat)</td><td>1 lab (privat)</td></tr>
          <tr class="row-group-header"><td colspan="6">Pendampingan &amp; Pakar</td></tr>
          <tr><td>Pendampingan pakar aktif</td><td><span class="check-no">✗</span></td><td><span class="check-partial">Selama pelatihan</span></td><td class="col-featured"><span class="check-yes">✓</span> <strong>15+ pakar, 6 bulan</strong></td><td><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr><td>Konsultasi privat 1-on-1</td><td><span class="check-no">✗</span></td><td><span class="check-no">✗</span></td><td class="col-featured"><span class="check-yes">✓</span> <strong>GRATIS 1 sesi/peserta</strong></td><td><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr class="row-group-header"><td colspan="6">Output &amp; Deliverable</td></tr>
          <tr><td>Output dokumen per sesi</td><td><span class="check-no">✗</span></td><td><span class="check-no">✗</span></td><td class="col-featured"><span class="check-yes">✓</span> <strong>Setiap sesi</strong></td><td><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr><td>Template dokumen ISO 17025</td><td><span class="check-no">✗</span></td><td><span class="check-no">✗</span></td><td class="col-featured"><span class="check-yes">✓</span> <strong>GRATIS (Rp 3,5 jt)</strong></td><td><span class="check-partial">Tersedia tambahan</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr><td>Laporan GAP Analysis</td><td><span class="check-no">✗</span></td><td><span class="check-no">✗</span></td><td class="col-featured"><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr class="row-group-header"><td colspan="6">Sertifikasi &amp; Kompetensi</td></tr>
          <tr><td>Sertifikat pelatihan (JP)</td><td><span class="check-no">✗</span></td><td><span class="check-yes">✓</span></td><td class="col-featured"><span class="check-yes">✓</span> <strong>Setiap sesi</strong></td><td><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr><td>Sertifikasi Kompetensi KAN</td><td><span class="check-no">✗</span></td><td><span class="check-yes">✓</span> (Rp 2–7 jt)</td><td class="col-featured"><span class="check-yes">✓</span> <strong>GRATIS (Rp 6,5 jt)</strong></td><td><span class="check-no">✗</span></td><td><span class="check-partial">Tersedia tambahan</span></td></tr>
          <tr class="row-group-header"><td colspan="6">Akses &amp; Komunitas</td></tr>
          <tr><td>Akses webinar 1 tahun</td><td><span class="check-no">✗</span></td><td><span class="check-no">✗</span></td><td class="col-featured"><span class="check-yes">✓</span> <strong>GRATIS (Rp 5 jt)</strong></td><td><span class="check-no">✗</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr><td>Grup diskusi nasional</td><td><span class="check-no">✗</span></td><td><span class="check-no">✗</span></td><td class="col-featured"><span class="check-yes">✓</span> Permanen</td><td><span class="check-yes">✓</span></td><td><span class="check-yes">✓</span></td></tr>
          <tr class="row-group-header"><td colspan="6">Hasil Akhir</td></tr>
          <tr><td>Target capaian</td><td>Tidak pasti</td><td>Kompetensi individu</td><td class="col-featured"><strong>Siap Audit Internal</strong></td><td><strong>Siap Asesmen KAN</strong></td><td><strong>Siap Akreditasi</strong></td></tr>
        </tbody>
        <tfoot>
          <tr>
            <td>Mulai dari sini</td>
            <td><span class="check-partial">Butuh waktu panjang</span></td>
            <td><a href="#" class="btn-comp btn-comp-outline">Lihat jadwal</a></td>
  ...
  <div class="decision-inner">
    ...
    <div class="decision-grid">
      <div class="decision-card">
        <div class="decision-header d-free"><div class="decision-num">01</div><div class="decision-tag">Anggaran nol atau sangat terbatas</div><div class="decision-title">Mulai dari yang gratis dulu.</div><div class="decision-price">100% Gratis</div></div>
        <div class="decision-body">
          <div class="decision-fit"><div class="decision-fit-title">Cocok jika...</div><div class="fit-item"><div class="fit-check">✓</div>Belum ada anggaran dari institusi</div><div class="fit-item"><div class="fit-check">✓</div>Masih tahap eksplorasi dan orientasi</div><div class="fit-item"><div class="fit-check">✓</div>Ingin tahu dulu kondisi lab sebelum commit</div><div class="fit-item"><div class="fit-check">✓</div>Mahasiswa atau fresh graduate</div></div>
      ...
      <div class="decision-card">
        <div class="decision-header d-core"><div class="decision-num">02</div><div class="decision-tag">Anggaran tersedia, ingin hasil nyata</div><div class="decision-title">Kelas Pendampingan adalah pilihan terbaik.</div><div class="decision-price">Rp 14–35 jt / lab</div></div>
        <div class="decision-body">
          <div class="decision-fit"><div class="decision-fit-title">Cocok jika...</div><div class="fit-item"><div class="fit-check">✓</div>Lab belum terakreditasi dan ingin mulai</div><div class="fit-item"><div class="fit-check">✓</div>Punya Rp 14–35 jt tapi tidak mampu Rp 150+ jt</div><div class="fit-item"><div class="fit-check">✓</div>Butuh pendampingan terstruktur 6 bulan</div><div class="fit-item"><div class="fit-check">✓</div>Ingin hasil: siap audit internal KAN</div></div>
      ...
      <div class="decision-card">
        <div class="decision-header d-premium"><div class="decision-num">03</div><div class="decision-tag">Anggaran besar, butuh hasil cepat</div><div class="decision-title">Kelas Lanjutan atau Full Pendampingan.</div><div class="decision-price">Rp 36 jt – 200 jt</div></div>
        <div class="decision-body">
          <div class="decision-fit"><div class="decision-fit-title">Cocok jika...</div><div class="fit-item"><div class="fit-check">✓</div>Sudah selesai Tahap 1–4 dan siap daftar KAN</div><div class="fit-item"><div class="fit-check">✓</div>Butuh pendampingan intensif &amp; privat</div><div class="fit-item"><div class="fit-check">✓</div>Institusi punya anggaran besar untuk IHT</div><div class="fit-item"><div class="fit-check">✓</div>Target akreditasi dalam 6–8 bulan ke depan</div></div>
  ...
  <div class="faq-inner" style="padding:80px 48px">
    ...
    <div class="faq-content-area">
      <div class="faq-group" id="faq-umum">
        ...
        <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Apa itu Labnesia dan apa yang membedakannya dari penyedia pelatihan lain? <span class="faq-chevron">▾</span></div><div class="faq-a"><p>Labnesia adalah Pusat Kompetensi ISO/IEC 17025 yang berfokus khusus pada laboratorium pengujian dan kalibrasi di Indonesia. Kami bukan hanya penyedia pelatihan — kami adalah mitra implementasi. Yang membedakan kami: <strong>(1) output nyata</strong> di setiap sesi bukan hanya materi, <strong>(2) para pakar</strong> yang benar-benar pernah mendampingi akreditasi bukan hanya teoritisi, <strong>(3) model publik yang terjangkau</strong> — dari yang biasanya Rp 150+ juta menjadi Rp 14–35 juta, dan <strong>(4) track record</strong> 30+ lab yang sudah berhasil terakreditasi KAN bersama kami.</p></div></div>
        <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Apakah Labnesia terakreditasi resmi? <span class="faq-chevron">▾</span></div><div class="faq-a"><p>Ya. Labnesia beroperasi di bawah Padma Global Nusatama dan bermitra dengan LSP Edukasi Global Cendekia (LSP-033-IDN), yang terakreditasi oleh Komite Akreditasi Nasional (KAN). Sertifikat kompetensi yang kami keluarkan diakui secara nasional dan merupakan sertifikat resmi dari lembaga yang terakreditasi KAN.</p></div></div>
      ...
      <div class="faq-group" id="faq-produk">
        ...
        <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Berapa sesi dalam Kelas Pendampingan dan berapa total jam pelatihan? <span class="faq-chevron">▾</span></div><div class="faq-a"><p>Total ada <strong>13 sesi</strong> yang tersebar dalam 4 tahap, dengan total <strong>64 JP (jam pelatihan)</strong>. Ini belum termasuk 40 JP untuk sertifikasi kompetensi KAN yang sudah termasuk gratis di dalam paket. Setiap sesi rata-rata 4 JP, dengan beberapa sesi teknis yang lebih panjang (8–16 JP).</p></div></div>
  ...
  <div class="chat-inner">
    <div class="chat-left">
      ...
      <div class="contact-options">
        <a href="https://wa.me/6282172221567" class="contact-opt"><div class="contact-icon" style="background:rgba(37,211,102,0.2)">💬</div><div><div class="contact-name">Endang — WhatsApp</div><div class="contact-val">+62 821-7222-1567 · Aktif 08.00–17.00</div></div></a>
        <a href="https://wa.me/6285185000367" class="contact-opt"><div class="contact-icon" style="background:rgba(37,211,102,0.2)">💬</div><div><div class="contact-name">Atikah — WhatsApp</div><div class="contact-val">+62 851-8500-0367 · Aktif 08.00–17.00</div></div></a>
        <a href="mailto:info@labnesia.id" class="contact-opt"><div class="contact-icon" style="background:rgba(255,255,255,0.1)">📧</div><div><div class="contact-name">Email</div><div class="contact-val">info@labnesia.id · Dijawab dalam 24 jam</div></div></a>
      </div>
    </div>
...
<footer>
  <div class="footer-bottom">
    ...
    <span><a href="<?php echo $url_home; ?>">Beranda</a> · <a href="<?php echo $url_gratis; ?>">Mulai Gratis</a> · <a href="<?php echo $url_kelas; ?>">Program</a></span>
  </div>
</footer>
