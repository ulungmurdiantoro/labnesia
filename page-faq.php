...
<?php wp_head(); ?>
<style>
  :root{--navy:#0B1F3A;--teal:#1A9E75;--teal-light:#22C28F;--teal-pale:#E8F7F2;--amber:#F5A623;--amber-pale:#FEF3DC;--white:#FFFFFF;--gray-50:#F8F9FA;--gray-200:#E9ECEF;--gray-400:#ADB5BD;--gray-600:#6C757D;--gray-800:#343A40;--font-display:'Plus Jakarta Sans',sans-serif;--font-serif:'Lora',serif}
    ...
    <div class="decision-grid">
      ...
      <div class="decision-card">
        ...
        <div class="decision-body">
          ...
          <a href="#kontak" class="btn btn-navy-d">Konsultasi kebutuhan <?php labnesia_icon( 'arrow-right', '#ffffff', 14 ); ?></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="faq-inner" style="padding:80px 48px">
    <div class="faq-nav">
      ...
      <div style="margin-top:28px;padding:16px;background:var(--teal-pale);border-radius:10px;border:1px solid rgba(26,158,117,0.2)">
        ...
        <a href="#kontak" style="display:block;text-align:center;padding:8px;background:var(--teal);color:white;border-radius:7px;font-size:12px;font-weight:700;text-decoration:none">Tanya Tim <?php labnesia_icon( 'arrow-right', '#ffffff', 12 ); ?></a>
      </div>
    </div>
