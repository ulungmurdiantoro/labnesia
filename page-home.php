...
<nav>
  ...
  <div class="nav-links">
    ...
    <a href="#konsultasi" class="nav-cta">Konsultasi Gratis</a>
  </div>
</nav>
  ...
  <div class="hero-inner">
    ...
    <div class="hero-map">
      ...
      <div class="journey-step">
        <div class="journey-dot dot-done"><?php labnesia_icon( 'check', '#ffffff', 17 ); ?></div>
      ...
      <div class="journey-step">
        <div class="journey-dot" style="background:var(--teal)"><?php labnesia_icon( 'graduation-cap', '#ffffff', 17 ); ?></div>
        <div class="journey-info">
      ...
      <div class="journey-step">
        ...
        <span class="journey-badge badge-adv"><?php labnesia_icon( 'trophy', 'rgba(255,255,255,.5)', 10 ); ?> Goal</span>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="section-inner">
    ...
    <div class="problem-grid">
      <div class="problem-card">
        <div class="problem-icon"><?php labnesia_icon( 'banknote', 'var(--teal)', 28 ); ?></div>
      ...
      <div class="problem-card">
        <div class="problem-icon"><?php labnesia_icon( 'compass', 'var(--teal)', 28 ); ?></div>
      ...
      <div class="problem-card">
        <div class="problem-icon"><?php labnesia_icon( 'hourglass', 'var(--teal)', 28 ); ?></div>
      ...
      <div class="problem-card">
        <div class="problem-icon"><?php labnesia_icon( 'user', 'var(--teal)', 28 ); ?></div>
      ...
      <div class="problem-card">
        <div class="problem-icon"><?php labnesia_icon( 'building-2', 'var(--teal)', 28 ); ?></div>
      ...
      <div class="problem-card">
        <div class="problem-icon"><?php labnesia_icon( 'search', 'var(--teal)', 28 ); ?></div>
  ...
  <div class="section-inner">
    ...
    <div class="give-grid">
      ...
      <div class="give-card">
        ...
        <div class="give-card-icon"><?php labnesia_icon( 'mic', '#ffffff', 33 ); ?></div>
      ...
      <div class="give-card">
        <span class="give-card-tag tag-gratis">100% Gratis</span>
        <div class="give-card-icon"><?php labnesia_icon( 'download', '#ffffff', 33 ); ?></div>
      ...
      <div class="give-card">
        ...
        <div class="give-card-icon"><?php labnesia_icon( 'zap', '#ffffff', 33 ); ?></div>
      ...
      <div class="give-card">
        ...
        <div class="give-card-icon"><?php labnesia_icon( 'graduation-cap', '#ffffff', 33 ); ?></div>
      ...
      <div class="give-card">
        ...
        <div class="give-card-icon"><?php labnesia_icon( 'message-circle', '#ffffff', 33 ); ?></div>
        ...
        <div class="ladder-step active">
          ...
          <div class="ladder-body">
            <div class="ladder-row">
              <span class="ladder-name"><?php labnesia_icon( 'star', 'var(--teal)', 13 ); ?> Kelas Pendampingan</span>
      ...
      <div class="product-card featured">
        <div class="product-card-header">
          <div class="product-card-top">
            ...
            <div class="featured-badge"><?php labnesia_icon( 'star', 'var(--navy)', 11 ); ?> Terpopuler</div>
          </div>
...
<section class="journey-section" id="mulai">
  <div class="section-inner">
    ...
    <div class="funnel-grid">
      ...
      <div class="funnel-step">
        <div class="funnel-icon" style="background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.15);"><?php labnesia_icon( 'trophy', '#ffffff', 29 ); ?></div>
...
<footer>
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <p style="margin-top:16px;font-size:13px;line-height:1.8;"><?php labnesia_icon( 'mail', 'rgba(255,255,255,.5)', 13 ); ?> info@labnesia.id<br><?php labnesia_whatsapp_link( '6282172221567', '+62 821-7222-1567 (Endang)', 'rgba(255,255,255,.5)', 13 ); ?><br><?php labnesia_whatsapp_link( '6285185000367', '+62 851-8500-0367 (Berryl)', 'rgba(255,255,255,.5)', 13 ); ?><br><?php labnesia_whatsapp_link( '62811399523', '+62 811-399-523 (Kintan)', 'rgba(255,255,255,.5)', 13 ); ?><br><?php labnesia_icon( 'map-pin', 'rgba(255,255,255,.5)', 13 ); ?> labnesia.id</p>
    </div>
  ...
  <div class="footer-bottom">
    ...
    <span>Mitra Pengembangan Laboratorium Indonesia · <a href="<?php echo $url_home; ?>">labnesia.id</a></span>
  </div>
</footer>
