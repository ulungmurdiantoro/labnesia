...
<footer>
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <p style="margin-top:16px;font-size:13px;line-height:1.8;"><?php labnesia_icon( 'mail', 'rgba(255,255,255,.5)', 13 ); ?> info@labnesia.id<br><?php labnesia_icon( 'phone', 'rgba(255,255,255,.5)', 13 ); ?> +62 821-7222-1567 (Endang)<br><?php labnesia_icon( 'phone', 'rgba(255,255,255,.5)', 13 ); ?> +62 851-8500-0367 (Berryl)<br><?php labnesia_icon( 'phone', 'rgba(255,255,255,.5)', 13 ); ?> +62 811-399-523 (Kintan)<br><?php labnesia_icon( 'map-pin', 'rgba(255,255,255,.5)', 13 ); ?> labnesia.id</p>
    </div>
