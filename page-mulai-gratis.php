...
<style>
  ...
  .page-hero::after{content:'';position:absolute;inset:0;background:radial-gradient(ellipse at 50% 0%,rgba(77, 161, 169,0.18) 0%,transparent 60%)}
  .page-hero-inner{max-width:800px;margin:0 auto;position:relative;z-index:1}
  .eyebrow-tag{display:inline-flex;align-items:center;gap:8px;background:rgba(77, 161, 169,0.15);border:1px solid rgba(77, 161, 169,0.3);color:var(--teal-light);padding:6px 16px;border-radius:100px;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;margin-bottom:24px}
  ...
  /* TRUST ROW */
  .trust-row{background:var(--teal-pale);border-bottom:1px solid rgba(77, 161, 169,0.2);padding:18px 48px}
  ...
  .gap-tag{display:inline-block;background:rgba(77, 161, 169,0.2);border:1px solid rgba(77, 161, 169,0.4);color:var(--teal-light);font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:5px 14px;border-radius:6px;margin-bottom:20px}
  ...
  .give-card:hover{border-color:var(--teal);transform:translateY(-3px);box-shadow:0 8px 24px rgba(77, 161, 169,0.1)}
  ...
  .tag-open{background:rgba(255, 154, 18,0.25);color:var(--amber);border:1px solid rgba(255, 154, 18,0.4)}
  ...
  .btn-daftar:hover{background:#43939A}
  ...
  .group-item:hover{background:rgba(255,255,255,0.1);border-color:rgba(77, 161, 169,0.4)}
  ...
  .btn-teal-solid:hover{background:#43939A}
  ...
  /* PRAKTISI */
  .praktisi-section{background:var(--amber-pale);border-top:1px solid rgba(255, 154, 18,0.3)}
  .praktisi-inner{max-width:1100px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:center}
  .praktisi-tag{display:inline-block;background:rgba(255, 154, 18,0.3);color:#6B4400;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:5px 14px;border-radius:6px;margin-bottom:16px}
  ...
  .btn-amber-solid:hover{background:#E58A14;transform:translateY(-1px)}
  .praktisi-visual{background:white;border-radius:20px;padding:32px;border:1px solid rgba(255, 154, 18,0.3)}
  ...
  .ps-tag{display:inline-block;background:var(--amber-pale);color:#845500;font-size:11px;font-weight:600;padding:2px 8px;border-radius:4px;margin-top:6px}
...
<section id="gap-analysis">
  <div class="section-inner">
    ...
    <div class="gives-grid">
      ...
      <div class="give-card">
        <div class="give-card-img" style="background:#607A98">
