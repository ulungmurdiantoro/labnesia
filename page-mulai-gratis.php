...
<nav>
  ...
  <div class="nav-links">
    ...
    <a href="<?php echo $url_kelas; ?>#daftar" class="nav-cta">Daftar Program</a>
  </div>
</nav>
  ...
  <div class="section-inner">
    ...
    <div class="gap-feature">
      ...
      <div class="gap-form">
        ...
        <div class="form-sub">Tim kami akan menghubungi Anda dalam 1×24 jam untuk menjadwalkan sesi.</div>
        <div class="form-field"><label class="form-label">Nama lengkap *</label><input class="form-input" type="text" placeholder="Nama Anda"></div>
        <div class="form-field"><label class="form-label">Jabatan / posisi *</label><select class="form-select"><option value="">Pilih jabatan Anda</option><option>Kepala Laboratorium</option><option>Manajer Mutu</option><option>Manajer Teknis</option><option>Analis / Laboran</option><option>Dosen / Peneliti</option><option>Pimpinan / Manajemen Institusi</option><option>Lainnya</option></select></div>
        <div class="form-field"><label class="form-label">Nama laboratorium &amp; institusi *</label><input class="form-input" type="text" placeholder="Mis: Lab Pangan FTP UGM"></div>
        <div class="form-field"><label class="form-label">Bidang laboratorium *</label><select class="form-select"><option value="">Pilih bidang lab</option><option>Lab Lingkungan</option><option>Lab Pangan / Gizi / Halal</option><option>Lab Sipil</option><option>Lab Pertanian / Pascapanen</option><option>Lab Farmasi / Kimia</option><option>Lab Biologi &amp; Mikrobiologi</option><option>Lab Kalibrasi</option><option>Lab Peternakan &amp; Perikanan</option><option>Lab Energi / Mineral</option><option>Lainnya</option></select></div>
        <div class="form-field"><label class="form-label">Nomor WhatsApp *</label><input class="form-input" type="tel" placeholder="08xx-xxxx-xxxx"></div>
        <div class="form-field"><label class="form-label">Kondisi lab saat ini</label><select class="form-select"><option>Belum punya dokumen mutu sama sekali</option><option>Punya sebagian dokumen, belum lengkap</option><option>Dokumen sudah ada tapi belum yakin apakah sesuai KAN</option><option>Pernah gagal asesmen, ingin coba lagi</option><option>Sudah terakreditasi, ingin re-akreditasi</option></select></div>
    ...
    <div class="gives-grid">
      <div class="give-card">
        <div class="give-card-img"><div class="give-card-icon">🎤</div><span class="give-card-tag tag-free">Gratis</span></div>
        <div class="give-card-body"><div class="give-card-title">Webinar Lab Talk</div><div class="give-card-desc">Sesi edukasi mingguan — insight, tips, studi kasus, dan update regulasi dari para pakar Labnesia.</div><div class="give-card-outputs"><div class="give-output-item"><div class="give-output-check">✓</div>Setiap Rabu, pukul 13.00–14.30 WIB</div><div class="give-output-item"><div class="give-output-check">✓</div>Rekaman tersedia untuk peserta terdaftar</div><div class="give-output-item"><div class="give-output-check">✓</div>Tanya jawab langsung dengan pakar</div></div><a href="#webinar" class="give-card-cta">Lihat jadwal →</a></div>
      </div>
      <div class="give-card">
        <div class="give-card-img" style="background:#1C3A60"><div class="give-card-icon">⚡</div><span class="give-card-tag tag-open">Terbuka Umum</span></div>
        <div class="give-card-body"><div class="give-card-title">Bootcamp 1 Hari</div><div class="give-card-desc">Intensif online 7 jam — alur akreditasi dari awal hingga cara daftar di KANMIS 2.0. Investasi sangat terjangkau.</div><div class="give-card-outputs"><div class="give-output-item"><div class="give-output-check">✓</div>Online, 7 JP dalam satu hari</div><div class="give-output-item"><div class="give-output-check">✓</div>Sertifikat pelatihan diberikan</div><div class="give-output-item"><div class="give-output-check">✓</div>Jadwal bulanan — pilih yang paling cocok</div></div><a href="#bootcamp" class="give-card-cta">Lihat jadwal →</a></div>
      </div>
      <div class="give-card">
        <div class="give-card-img" style="background:#0B2D1A"><div class="give-card-icon">🎓</div><span class="give-card-tag tag-free">Gratis untuk kampus mitra</span></div>
        <div class="give-card-body"><div class="give-card-title">Kuliah Praktisi</div><div class="give-card-desc">Labnesia hadir ke kampus Anda — sesi tatap muka untuk mahasiswa tingkat akhir &amp; fresh graduate tentang karir di bidang lab.</div><div class="give-card-outputs"><div class="give-output-item"><div class="give-output-check">✓</div>Untuk mahasiswa tingkat akhir &amp; wisudawan</div><div class="give-output-item"><div class="give-output-check">✓</div>Materi: Lab Career, Sertifikasi KAN, Dunia Lab</div><div class="give-output-item"><div class="give-output-check">✓</div>Gratis untuk kampus yang mengundang</div></div><a href="#praktisi" class="give-card-cta">Undang Labnesia →</a></div>
      </div>
    </div>
  </div>
</section>
...
<section class="download-section" id="download">
  <div class="section-inner">
    ...
    <div class="download-grid">
      <div class="dl-card"><div class="dl-icon">📘</div><div class="dl-title">Panduan SNI ISO/IEC 17025:2017</div><div class="dl-desc">Ringkasan klausul &amp; persyaratan standar yang mudah dipahami</div><a href="#" class="dl-btn">↓ Unduh PDF</a><div class="dl-format">PDF · 24 halaman</div></div>
      <div class="dl-card"><div class="dl-icon">📋</div><div class="dl-title">Checklist Persiapan Akreditasi KAN</div><div class="dl-desc">Daftar lengkap dokumen yang dibutuhkan sebelum mendaftar akreditasi</div><a href="#" class="dl-btn">↓ Unduh Excel</a><div class="dl-format">XLSX · checklist interaktif</div></div>
      <div class="dl-card"><div class="dl-icon">📚</div><div class="dl-title">Silabus Lengkap Kelas Pendampingan</div><div class="dl-desc">Outline 13 sesi, output per sesi, dan timeline 6 bulan program</div><a href="#" class="dl-btn">↓ Unduh PDF</a><div class="dl-format">PDF · 16 halaman</div></div>
      <div class="dl-card"><div class="dl-icon">🗓️</div><div class="dl-title">Template Roadmap Implementasi</div><div class="dl-desc">Template Excel untuk menyusun rencana implementasi ISO 17025 lab Anda</div><a href="#" class="dl-btn">↓ Unduh Excel</a><div class="dl-format">XLSX · bisa disesuaikan</div></div>
    </div>
  </div>
</section>
...
<section id="webinar">
  <div class="section-inner">
    ...
    <div class="webinar-list">
      <div class="webinar-item"><div class="webinar-date" style="background:var(--teal)"><div class="webinar-day">9</div><div class="webinar-month">Jul 26</div></div><div class="webinar-info"><div class="webinar-title">Memahami Klausul ISO/IEC 17025 dari Perspektif Asesor KAN</div><div class="webinar-meta"><span>🕐 13.00–14.30 WIB</span><span>🌐 Zoom · Online</span><span class="webinar-tag">Awareness</span></div></div><div class="webinar-cta"><a href="#" class="btn-daftar">Daftar gratis</a></div></div>
      <div class="webinar-item"><div class="webinar-date"><div class="webinar-day">16</div><div class="webinar-month">Jul 26</div></div><div class="webinar-info"><div class="webinar-title">Cara Menyusun Dokumen Mutu ISO 17025 yang Benar-Benar Lulus Audit</div><div class="webinar-meta"><span>🕐 13.00–14.30 WIB</span><span>🌐 Zoom · Online</span><span class="webinar-tag">Dokumen</span></div></div><div class="webinar-cta"><a href="#" class="btn-daftar">Daftar gratis</a></div></div>
      <div class="webinar-item"><div class="webinar-date"><div class="webinar-day">23</div><div class="webinar-month">Jul 26</div></div><div class="webinar-info"><div class="webinar-title">Ketidakpastian Pengujian — Konsep Dasar yang Sering Disalahpahami</div><div class="webinar-meta"><span>🕐 13.00–14.30 WIB</span><span>🌐 Zoom · Online</span><span class="webinar-tag">Teknis</span></div></div><div class="webinar-cta"><a href="#" class="btn-daftar-outline">Ingatkan saya</a></div></div>
      <div class="webinar-item" style="opacity:.6"><div class="webinar-date" style="background:var(--gray-400)"><div class="webinar-day">2</div><div class="webinar-month">Jul 26</div></div><div class="webinar-info"><div class="webinar-title">Audit Internal ISO 17025 — Simulasi Temuan &amp; Tindakan Perbaikan</div><div class="webinar-meta"><span>🕐 13.00–14.30 WIB</span><span>✓ Sudah selesai</span><span class="webinar-tag" style="background:var(--gray-100);color:var(--gray-600)">Rekaman tersedia</span></div></div><div class="webinar-cta"><a href="#" class="btn-daftar-outline">Minta rekaman</a></div></div>
    </div>
  </div>
</section>
...
<section class="community-section">
  <div class="community-inner" style="padding:80px 48px">
    <div class="community-left">
      ...
      <p class="body" style="margin-bottom:20px">Ribuan Manajer Mutu, analis, dan auditor internal dari seluruh Indonesia — sharing pengalaman, tanya pakar, dan update regulasi KAN terbaru.</p>
      <div class="group-list">
        <div class="group-item"><div class="group-icon">🔬</div><div style="flex:1"><div class="group-name">Forum Kompeten ISO/IEC 17025</div><div class="group-desc">Diskusi umum akreditasi lab, tanya jawab, info batch</div></div><div class="group-count">2.4k anggota</div></div>
        <div class="group-item"><div class="group-icon">🏫</div><div style="flex:1"><div class="group-name">Labnesia Expert Network — PT</div><div class="group-desc">Khusus untuk lab perguruan tinggi &amp; dosen</div></div><div class="group-count">890 anggota</div></div>
        <div class="group-item"><div class="group-icon">🏭</div><div style="flex:1"><div class="group-name">LEN — Industri &amp; Pemerintah</div><div class="group-desc">Lab industri, BUMN, dan laboratorium pemerintah</div></div><div class="group-count">1.1k anggota</div></div>
        <div class="group-item"><div class="group-icon">⭐</div><div style="flex:1"><div class="group-name">VIP Member — Alumni Program</div><div class="group-desc">Eksklusif untuk peserta program Labnesia</div></div><div class="group-count">340 anggota</div></div>
      </div>
    </div>
    <div class="community-form">
      ...
      <select style="width:100%;padding:11px 14px;border:1px solid rgba(255,255,255,0.15);border-radius:9px;font-size:14px;font-family:var(--font-display);outline:none;background:rgba(255,255,255,0.07);color:rgba(255,255,255,0.7);margin-bottom:12px"><option value="">Pilih grup yang ingin diikuti</option><option>Forum Kompeten ISO/IEC 17025 (Umum)</option><option>Labnesia Expert Network — Perguruan Tinggi</option><option>LEN — Industri &amp; Pemerintah</option></select>
      ...
      <div class="existing-members"><div class="avatar-stack"><div class="avatar-sm">WS</div><div class="avatar-sm">RP</div><div class="avatar-sm">HZ</div><div class="avatar-sm">MY</div></div><div class="member-count">+4.700 profesional lab Indonesia sudah bergabung</div></div>
    </div>
  </div>
</section>
...
<section class="praktisi-section" id="praktisi">
  <div class="praktisi-inner" style="padding:80px 48px">
    <div>
      ...
      <p class="praktisi-desc">Labnesia hadir ke kampus Anda membawa wawasan nyata tentang dunia laboratorium — dari sertifikasi kompetensi, akreditasi ISO 17025, hingga karir profesional di bidang lab.</p>
    ...
    <div class="praktisi-visual">
      ...
      <div class="praktisi-scenario"><div class="ps-label">Untuk mahasiswa umum</div><div class="ps-title">Karir di Bidang Lab: Lebih dari Sekadar Analis</div><div class="ps-desc">Laboratory Quality Officer, Manajer Mutu, Auditor Internal, QC Analyst — peluang yang belum banyak diketahui</div><span class="ps-tag">Lab Career</span></div>
      <div class="praktisi-scenario"><div class="ps-label">Untuk mahasiswa lab / teknik / pertanian</div><div class="ps-title">Apa itu ISO/IEC 17025 &amp; Mengapa Lab Wajib Terakreditasi</div><div class="ps-desc">Pengenalan sistem mutu laboratorium, akreditasi KAN, dan peran SDM dalam membangun lab berkualitas</div><span class="ps-tag">Awareness</span></div>
      <div class="praktisi-scenario"><div class="ps-label">Untuk dosen &amp; pengelola lab PT</div><div class="ps-title">Lab sebagai Profit Center &amp; Pencapaian IKU</div><div class="ps-desc">Bagaimana akreditasi ISO 17025 mendukung IKU 2, 5, 9 dan menjadikan lab sumber pendapatan institusi</div><span class="ps-tag">IKU &amp; Bisnis Lab</span></div>
    </div>
  </div>
</section>
...
<section class="faq-mini-section">
  <div class="section-inner" style="max-width:720px">
    ...
    <div class="faq-mini-item" onclick="toggleFaqMini(this)"><div class="faq-mini-q">Apakah GAP Analysis benar-benar gratis? Ada catch-nya? <span>▾</span></div><div class="faq-mini-a">Ya, benar-benar gratis — tidak ada kewajiban untuk mendaftar program berbayar setelahnya. Kami lakukan ini karena kami percaya bahwa laboratorium yang sudah merasakan kualitas pendampingan kami akan memutuskan sendiri langkah berikutnya. Ini adalah bagian dari filosofi "give first" yang kami pegang.</div></div>
    <div class="faq-mini-item" onclick="toggleFaqMini(this)"><div class="faq-mini-q">Berapa lama proses GAP Analysis? <span>▾</span></div><div class="faq-mini-a">Setelah mendaftar, tim kami menghubungi Anda dalam 1×24 jam untuk menjadwalkan sesi. Sesi GAP Analysis berlangsung sekitar 90–120 menit secara online. Laporan dikirimkan dalam 3–5 hari kerja setelah sesi.</div></div>
    <div class="faq-mini-item" onclick="toggleFaqMini(this)"><div class="faq-mini-q">Apakah webinar tersedia secara rekaman? <span>▾</span></div><div class="faq-mini-a">Ya, semua webinar yang sudah berlangsung tersedia rekamannya. Daftar ke komunitas kami dan minta akses rekaman melalui grup WhatsApp. Untuk peserta Kelas Pendampingan, semua rekaman tersedia otomatis.</div></div>
    <div class="faq-mini-item" onclick="toggleFaqMini(this)"><div class="faq-mini-q">Saya mahasiswa, apakah bisa ikut? <span>▾</span></div><div class="faq-mini-a">Tentu. Webinar dan komunitas terbuka untuk semua termasuk mahasiswa. Untuk Program Kuliah Praktisi, mintalah dosen atau pihak kampus Anda untuk mengundang Labnesia — gratis untuk kampus yang mengundang. Kelas Pendampingan berbayar lebih cocok untuk yang sudah berperan aktif di lab (Manajer Mutu, Manajer Teknis, dll).</div></div>
...
<footer>
  <div class="footer-bottom">
    <span>© <?php echo date('Y'); ?> Labnesia · Padma Global Nusatama · Terakreditasi KAN LSP-033-IDN</span>
    <span><a href="<?php echo $url_home; ?>">Beranda</a> · <a href="<?php echo $url_kelas; ?>">Program</a> · <a href="<?php echo $url_faq; ?>">FAQ</a></span>
  </div>
</footer>

<script>
function submitGap(){alert('Pendaftaran GAP Analysis diterima! Tim kami akan menghubungi Anda dalam 1×24 jam.')}
