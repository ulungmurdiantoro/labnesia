  ...
  <div class="section-inner">
    ...
    <div class="stats-row">
      <div class="stat-card">
        ...
        <div class="stat-label">Laboratorium berhasil terakreditasi ISO/IEC 17025 oleh Komite Akreditasi Nasional (KAN)</div>
      </div>
      <div class="stat-card">
  ...
  <div class="section-inner">
    ...
    <div class="funnel-grid">
      <div class="funnel-step">
        <div class="funnel-icon" style="background:rgba(26,158,117,0.15);border-color:rgba(26,158,117,0.3);"><?php labnesia_icon( 'target', '#ffffff', 26 ); ?></div>
