  ...
  <div class="chat-inner">
    ...
    <div class="chat-right">
      <form id="kontak-form" onsubmit="return submitKontakForm(event)">
        ...
        <div class="form-error" id="kontak-error" style="display:none;background:var(--amber-pale);color:#6B4400;border:1px solid rgba(255, 236, 122,0.3);border-radius:8px;padding:10px 14px;font-size:13px;margin-bottom:12px"></div>
