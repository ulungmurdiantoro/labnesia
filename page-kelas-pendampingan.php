  ...
  <div id="daftar">
    ...
    <div id="form-daftar" style="margin-top:20px;background:white;border:1px solid var(--gray-200);border-radius:16px;padding:24px">
      ...
      <div style="display:flex;flex-direction:column;gap:12px">
        <div><label style="font-size:12px;font-weight:600;color:var(--gray-800);display:block;margin-bottom:5px">Nama lengkap *</label><input type="text" placeholder="Nama Anda" style="width:100%;padding:10px 14px;border:1px solid var(--gray-200);border-radius:8px;font-size:14px;font-family:var(--font-display);outline:none;transition:border .2s" onfocus="this.style.borderColor='var(--teal)'" onblur="this.style.borderColor='var(--gray-200)'"></div>
        <div><label style="font-size:12px;font-weight:600;color:var(--gray-800);display:block;margin-bottom:5px">Nama laboratorium / instansi *</label><input type="text" placeholder="Lab / Universitas / Perusahaan" style="width:100%;padding:10px 14px;border:1px solid var(--gray-200);border-radius:8px;font-size:14px;font-family:var(--font-display);outline:none;transition:border .2s" onfocus="this.style.borderColor='var(--teal)'" onblur="this.style.borderColor='var(--gray-200)'"></div>
        <div><label style="font-size:12px;font-weight:600;color:var(--gray-800);display:block;margin-bottom:5px">Nomor WhatsApp *</label><input type="tel" placeholder="08xx-xxxx-xxxx" style="width:100%;padding:10px 14px;border:1px solid var(--gray-200);border-radius:8px;font-size:14px;font-family:var(--font-display);outline:none;transition:border .2s" onfocus="this.style.borderColor='var(--teal)'" onblur="this.style.borderColor='var(--gray-200)'"></div>
        <div><label style="font-size:12px;font-weight:600;color:var(--gray-800);display:block;margin-bottom:5px">Jumlah peserta</label><select style="width:100%;padding:10px 14px;border:1px solid var(--gray-200);border-radius:8px;font-size:14px;font-family:var(--font-display);outline:none;background:white"><option>1 peserta — Rp 14.000.000</option><option>2 peserta — Rp 26.000.000</option><option value="3" selected>3 peserta — Rp 35.000.000 (Best Value)</option></select></div>
        <div><label style="font-size:12px;font-weight:600;color:var(--gray-800);display:block;margin-bottom:5px">Bidang laboratorium</label><select style="width:100%;padding:10px 14px;border:1px solid var(--gray-200);border-radius:8px;font-size:14px;font-family:var(--font-display);outline:none;background:white"><option>Lab Lingkungan</option><option>Lab Pangan / Gizi / Halal</option><option>Lab Sipil</option><option>Lab Pertanian / Pascapanen</option><option>Lab Farmasi / Kimia</option><option>Lab Biologi &amp; Mikrobiologi</option><option>Lab Kalibrasi</option><option>Lab Peternakan &amp; Perikanan</option><option>Lainnya</option></select></div>
