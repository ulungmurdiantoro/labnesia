...
<style>
  ...
  .sticky-promo{background:var(--amber-pale);color:#845500;font-size:12px;font-weight:700;padding:3px 10px;border-radius:4px}
  ...
  .btn-amber:hover{background:#E58A14}
  ...
  .btn-booklet{background:linear-gradient(135deg,#FF9A12 0%,#FFB646 100%);color:var(--navy);padding:11px 24px;border-radius:9px;font-weight:800;font-size:14px;text-decoration:none;border:none;cursor:pointer;transition:all .2s;display:inline-flex;align-items:center;gap:8px;box-shadow:0 4px 14px rgba(255, 154, 18,.45)}
  .btn-booklet:hover{transform:translateY(-1px);box-shadow:0 6px 18px rgba(255, 154, 18,.6)}
  ...
  .outline-badge{font-size:11px;font-weight:600;padding:3px 10px;border-radius:4px;background:var(--amber-pale);color:#845500;white-space:nowrap}
  ...
  .urgency{background:var(--amber-pale);border:1px solid #FF9A12;border-radius:8px;padding:10px 14px;text-align:center;margin:0 24px 20px}
  .urgency-text{font-size:12px;font-weight:600;color:#845500}
  ...
  .pt-active-ring{box-shadow:0 0 0 3px rgba(255, 154, 18,.6)}
  ...
  .tag-batch{display:inline-flex;align-items:center;gap:6px;background:rgba(255, 154, 18,0.15);border:1px solid rgba(255, 154, 18,0.3);color:#8B5800;padding:4px 12px;border-radius:6px;font-size:12px;font-weight:700}
...
<div class="sticky-bar">
  <div style="display:flex;align-items:center;gap:20px">
    ...
    <span class="sticky-promo"><?php labnesia_icon( 'zap', '#845500', 12 ); ?> Hemat s.d. Rp 20 juta</span>
  </div>
...
<div class="main-layout">
  ...
  <div>
    ...
    <div id="outline" style="margin-bottom:56px">
      ...
      <div style="background:var(--amber-pale);border:1px solid rgba(255, 154, 18,0.3);border-radius:12px;padding:20px;display:flex;gap:14px;align-items:flex-start;margin-top:16px">
  ...
  <div id="daftar">
    <div class="price-card">
      ...
      <div class="urgency">
        <p class="urgency-text"><?php labnesia_icon( 'hourglass', '#845500', 12 ); ?> Batch Oktober 2026 dibuka — <strong>maks. 10 instansi/batch</strong></p>
      </div>
