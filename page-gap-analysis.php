...
.sticky-score-btn:hover{background:#43939A}

/* PANDUAN SKOR */
.guide-section{background:var(--navy-mid, #476587);padding:36px 48px}
...
.guide-card.s1{border-color:rgba(255, 236, 122,0.4);background:rgba(255, 236, 122,0.1)}
...
.result-total{background:rgba(121, 215, 190,0.15);border:1px solid rgba(121, 215, 190,0.3);border-radius:12px;padding:24px;text-align:center;margin-bottom:24px}
...
.result-interpretation.mid{background:rgba(255, 236, 122,0.15);border:1px solid rgba(255, 236, 122,0.3);color:#ffd54f}
...
.btn-konsul{background:var(--amber);color:var(--navy);padding:11px 22px;border-radius:9px;font-weight:700;font-size:14px;text-decoration:none;display:inline-flex;align-items:center;gap:8px;border:2px solid var(--navy);box-shadow:0 2px 8px rgba(46,80,119,0.2);transition:all .2s}
.btn-konsul:hover{background:#D1C264;box-shadow:0 4px 14px rgba(46,80,119,0.3)}
...
.btn-hitung:hover{background:#43939A;transform:translateY(-2px)}
